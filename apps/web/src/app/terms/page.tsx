...
export const metadata: Metadata = pageMetadata({
  ...
  description: `Terms and conditions for shopping on ${site.name} — Halloween delivery to the USA.`,
  path: "/terms",
});
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-slate-700 leading-relaxed text-sm sm:text-base">
        ...
        <p>
          We deliver Halloween items to addresses within the United States. Delivery times are estimates (typically 5–7
