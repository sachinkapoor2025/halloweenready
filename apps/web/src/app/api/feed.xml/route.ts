...
export async function GET() {
  ...
  <g:brand>HalloweenReady</g:brand>
...
<channel>
<title>HalloweenReady — Shop Halloween to USA</title>
<link>${escapeXml(site)}</link>
<description>Halloween products delivered to all 50 US states</description>
${items}
</channel>
</rss>`;
