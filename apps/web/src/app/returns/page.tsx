...
export const metadata: Metadata = pageMetadata({
  ...
  description: `HalloweenReady returns, replacements, and satisfaction guarantee for Halloween orders delivered in the USA.`,
  path: "/returns",
});
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-6 text-slate-700 leading-relaxed text-sm sm:text-base">
        <p>
          At {site.name}, we want every Halloween delivery to feel special. If something goes wrong with your
