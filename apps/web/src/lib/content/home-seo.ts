...
export const homeSeoContent = {
  ...
  categories: {
    heading: "Shop Halloween by Category",
    intro: "Browse curated collections for every haunt — from full costumes to finishing touches and party essentials.",
    links: [
      {
        label: "Costumes",
        href: "/categories/costumes",
        text: "Adult, teen, and kids costumes — horror classics, pop culture, and group sets.",
      },
      {
        label: "Decorations",
        href: "/categories/decorations",
        text: "Inflatable yard decor, LED pumpkins, fog machines, and haunted house props.",
      },
      {
        label: "Candy & Treats",
        href: "/categories/candy-treats",
        text: "Bulk candy assortments, chocolate mixes, and pre-filled treat bags.",
      },
      {
        label: "Accessories",
        href: "/categories/accessories",
        text: "Masks, wigs, makeup kits, capes, and glow sticks to complete any look.",
      },
      {
        label: "Party Supplies",
        href: "/categories/party-supplies",
        text: "Plates, balloons, photo booth props, and themed tableware for Halloween parties.",
      },
    ],
  },
  delivery: {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes. Our costume collection includes toddler, kids, teen, and adult sizes across many themes.",
    },
    {
      q: "Do you sell bulk Halloween candy?",
      a: "Yes. Shop bulk assortments, chocolate variety packs, and pre-filled treat bags for trick-or-treat night.",
    },
  ],
} as const;
