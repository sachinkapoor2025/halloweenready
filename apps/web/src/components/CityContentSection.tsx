    ...
    <div className="mt-12 pt-10 border-t border-slate-200">
        ...
        <article className="space-y-8 text-slate-700 leading-relaxed">
          ...
          <section>
            <h3 className="text-xl font-semibold text-primary mb-3">
              Halloween in {content.label}
            </h3>
            <p className="mb-3">
              Halloween in {content.label} means costumes, yard displays, trick-or-treat prep, and parties.
              {site.name} offers costumes, decor, party supplies, and novelty items — confirm shipping on each
              product page.
            </p>
          </section>
        </article>
        ...
        <aside className="space-y-6">
          ...
          <section className="bg-nav text-white rounded-xl p-6">
            ...
            <div className="flex flex-wrap gap-3 text-sm">
              ...
              <a
                href={whatsappChatUrl(`Hi, I need Halloween delivery to ${content.label}.`)}
                target="_blank"
      ...
      <section className="mt-10 pt-8 border-t border-slate-200">
        <h3 className="text-xl font-semibold text-primary mb-6">
          Frequently Asked Questions — Halloween Delivery to {content.label}
        </h3>
