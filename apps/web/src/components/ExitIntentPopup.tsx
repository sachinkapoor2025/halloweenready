...
const STORAGE_KEY = "halloweenready_exit_intent_shown";
...
export function ExitIntentPopup() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatus("idle");
      setError(err instanceof Error ? err.message : "Could not send offer email. Try again or email order@halloweenready.com.");
    }
  };
        ...
        {status === "done" ? (
          <div className="text-center py-4">
            ...
            {coupon ? (
              ...
              <p className="text-sm text-slate-600 mb-3">
                Check your inbox for your 10% first-order offer. Order soon — Halloween is October 31, 2026.
              </p>
            )}
            <Link
              href="/products"
          ...
          <>
            ...
            <h2 className="text-xl font-bold text-accent mb-2">Get 10% off your first Halloween order</h2>
            <p className="text-sm text-slate-300 mb-4">
              Costumes, decor, and candy delivered across the USA. Enter your email for a welcome discount code.
            </p>
