...
const DISMISS_KEY = "halloweenready_stay_updated_dismissed";
const SUBSCRIBED_KEY = "halloweenready_stay_updated_subscribed";
            ...
            <form onSubmit={subscribe} className="space-y-3">
              <div className="text-center">
                ...
                <p className="mt-1 text-xs text-slate-600">
                  Share your email for new offers and top-selling Halloween picks.
                </p>
              </div>
              <input
                type="email"
