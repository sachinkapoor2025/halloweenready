 ...
 *
 * Usage:
 *   ENVIRONMENT=prod UPLOAD_BUCKET=halloweenready-prod-uploadbucket-dyr0xdywradd CLOUDFRONT_DOMAIN=d2lfdzx32wxe94.cloudfront.net npx tsx scripts/reconcile-s3-product-images.ts
 */
