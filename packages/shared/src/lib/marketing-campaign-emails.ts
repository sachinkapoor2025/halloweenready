...
export const FREE_SHIPPING_EMAIL_CONFIG = {
  ...
  offerBody:
    "Stock up on Halloween decorations, costumes, and party supplies — and enjoy free domestic shipping when your order is $7 or more. Ships from the USA. No customs delays.",
...
export const STARTING_PRICE_EMAIL_CONFIG = {
  ...
  offerBody:
    "Get Halloween-ready without stretching your budget. Explore decorations, costumes, and party supplies with festive packaging and USA delivery.",
  ctaText: "Shop Deals",
  ctaHref: SHOP,
  sections: [
    {
...
export const SHOP_MORE_SAVE_MORE_EMAIL_CONFIG = {
  ...
  preheader:
    "Shop more, save more on Halloween decorations, costumes, and party supplies with USA delivery.",
  logoUrl: LOGO,
  logoHref: SITE_SHORT,
