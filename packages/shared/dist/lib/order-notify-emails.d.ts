...
export declare const ORDER_SMTP_USER = "order@halloweenready.com";
/**
 ...
 */
export declare const DEFAULT_ORDER_NOTIFY_EMAILS: readonly ["order@halloweenready.com", "order@usarakhi.com", "priya.yadav@mydgv.com"];
