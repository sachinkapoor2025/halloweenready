...
exports.DEFAULT_CHECKOUT_NUDGE_SUBJECT = exports.sendReminderEmailsSchema = exports.reminderEmailSchema = exports.REMINDER_EMAIL_SOURCES = exports.REMINDER_EMAIL_STATUSES = void 0;
exports.defaultCheckoutNudgeHtml = defaultCheckoutNudgeHtml;
const zod_1 = require("zod");
exports.REMINDER_EMAIL_STATUSES = ["show", "deleted"];
exports.REMINDER_EMAIL_SOURCES = [
    "lead",
    "visitor",
    "abandoned_cart",
    "welcome_coupon",
...
exports.reminderEmailSchema = zod_1.z.object({
    ...
    status: zod_1.z.enum(exports.REMINDER_EMAIL_STATUSES).default("show"),
    createdAt: zod_1.z.string(),
    updatedAt: zod_1.z.string(),
    deletedAt: zod_1.z.string().optional(),
    lastReminderSentAt: zod_1.z.string().optional(),
    reminderCount: zod_1.z.number().int().min(0).default(0),
});
exports.sendReminderEmailsSchema = zod_1.z.object({
      ...
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
        ...
        <tr><td style="padding:28px;">
          ...
          <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#334155;">
            ...
            Halloween is near — finish checkout so your order arrives on time.
          </p>
          ...
          <p style="margin:0;font-size:14px;line-height:1.6;color:#64748b;">
            Or browse the collection: <a href="${shopUrl}" style="color:#7c1d3a;">Shop Halloween</a>
          </p>
        </td></tr>
